...
#define IOMUX_FLEXIO_DEFAULT  (IOMUX_DRIVE_40OHM | \
                               IOMUX_SPEED_MEDIUM)

#define GPIO_FLEXIO3_FLEXIO04_1   (GPIO_PERIPH | GPIO_ALT9 | GPIO_PADMUX(IMXRT_PADMUX_GPIO_AD_B1_04_INDEX))
#define GPIO_FLEXIO3_FLEXIO05_1   (GPIO_PERIPH | GPIO_ALT9 | GPIO_PADMUX(IMXRT_PADMUX_GPIO_AD_B1_05_INDEX))
//#define GPIO_FLEXIO3_FLEXIO06_1   (GPIO_PERIPH | GPIO_ALT9 | GPIO_PADMUX(IMXRT_PADMUX_GPIO_AD_B1_06_INDEX))
#define GPIO_FLEXIO3_FLEXIO11_1   (GPIO_PERIPH | GPIO_ALT9 | GPIO_PADMUX(IMXRT_PADMUX_GPIO_AD_B1_11_INDEX))

#define GPIO_FLEXIO3_FSYNC        (GPIO_FLEXIO3_FLEXIO04_1 | IOMUX_FLEXIO_DEFAULT)
#define GPIO_FLEXIO3_BCLK         (GPIO_FLEXIO3_FLEXIO05_1 | IOMUX_FLEXIO_DEFAULT)
