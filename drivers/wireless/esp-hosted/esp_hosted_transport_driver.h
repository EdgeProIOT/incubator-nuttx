/****************************************************************************
 * drivers/wireless/esp-hosted/esp_hosted_transport_driver.h
 *
...
#ifndef __ESP_HOSTED_TRANSPORT_DRV_H
#define __ESP_HOSTED_TRANSPORT_DRV_H
...
/* netdev APIs*/
int esp_hosted_netdev_open(netdev_handle_t netdev);
int esp_hosted_netdev_close(netdev_handle_t netdev);
int esp_hosted_netdev_xmit(netdev_handle_t netdev, struct pbuf *net_buf);
